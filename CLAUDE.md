...
- **214 Flask routes** in `server.py`, grouped by prefix: `/api/servers/*` (~98, the bulk — lifecycle, files, mods, players, backups, properties, NBT, tasks, messages), `/api/admin/*` (25), `/api/jar-bucket/*` (17), `/api/settings/*` (22), `/api/auth/*` (16), `/api/tools/*` (6), `/api/notifications/*` (6), `/api/jobs/*` (5), `/api/system/*` (4), `/api/setup/*` (2), `/api/stats`, plus static page routes.
